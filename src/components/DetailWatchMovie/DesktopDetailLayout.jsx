        ...
        <div className="relative mb-12">
          ...
          >
            ...
            <div className="absolute bottom-8 left-8 right-8 z-10">
              <h1 className="text-4xl lg:text-5xl font-extrabold mb-2 text-white tracking-tight">{movieData.name}</h1>
              <p className="text-xl text-white/80 mb-4">{movieData.origin_name}</p>
