...
const CHANGELOG = [
  {
    id: "changelog-ui-redesign",
    icon: Sparkles,
    iconBg: "bg-iris-500/15",
    iconColor: "text-iris-300",
    title: "Giao diện mới đẹp hơn nhiều",
    description: "Toàn bộ giao diện được làm lại — tối hơn, mượt hơn, dễ dùng hơn trên cả điện thoại lẫn máy tính.",
    time: "Hôm nay",
    isNew: true,
  },
  {
    ...
    title: "Xem phim không còn quảng cáo",
    description: "Quảng cáo bị chặn hoàn toàn trước khi phát — không bị chuyển sang quảng cáo giữa chừng nữa.",
    time: "Hôm nay",
  },
];
