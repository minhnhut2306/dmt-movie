                    ...
                    <div className="grid grid-cols-4 gap-2">
                      {server.server_data.map((episode, episodeIndex) => (
                        <button
                          ...
                          className={`group relative overflow-hidden rounded-lg font-medium text-xs transition-all duration-300 transform ${currentServer === serverIndex && currentEpisode === episodeIndex
